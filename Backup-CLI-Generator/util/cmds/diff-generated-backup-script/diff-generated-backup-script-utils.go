package diffgeneratedbackupscript
...
func DiffGeneratedBackupShellScript(generatedConfigFileContents string, shellScriptPath string) error {
	...
	diffs := dmp.DiffMain(string(content), generatedConfigFileContents, false)
